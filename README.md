...
* Crop-resistant hashing - crop_resistant_hash
...
Позволяет определять схожести в обрезанных изображениях. Происходит это путем разбития изображения на сегменты, вычисления хэшэй каждого сегмента и сравнения их с сегментами исходного изображения. Результат представляет собой кортеж двух числе *(x, y)* ,где *x* - количество совпавших сегментов, *y* - сумма расстояний Хэмминга совпадающих Хэшэй.

|Изображение 1|Изображение 2|Разница|
|-----|-----|-----|
|![Image9](img/kvar_9.jpg)|![Image14](img/kvar_14.jpg)|(3, 9)|
|![Image3](img/kvar_3.jpg)|![Image4](img/kvar_4.jpg)|(5, 36)|
|![Image11](img/kvar_11.jpg)|![Image13](img/kvar_13.jpg)|(0, 0)|
|![Image11](img/kvar_11.jpg)|![Image14](img/kvar_14.jpg)|(0, 0)|

### Скорость выполнения

#### Вычисление хэша

Время выполнения 1000 итераций
...
|crop_resistant_hash|520.6972045898438|510.99022221565247|

#### Вычисление разностей хэша

Время выполнения 10.000 итераций

|Метод|Время выполнения|
|-----|-----|
|aHash|0.06901788711547852|
|dHash|0.0689995288848877|
|pHash|0.08462977409362793|
|whash|0.06901717185974121|
|colorhash|0.07839322090148926|
|crop_resistant_hash|1.9049503803253174|
